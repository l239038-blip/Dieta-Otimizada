...
* [Input do Programa](#Input-do-Programa)
* [Definição Função Objetivo e Restrições](#Definição-Função-Objetivo-e-Restrições)
* [Output do Programa](#Output-do-Programa)
...
## 8. Equipe
Este projeto foi desenvolido por:
